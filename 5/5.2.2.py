...
a = 0
b = 20 #با آزمون خطا در آوردم.. میشه دید integrand کجا به صفر نزدیک میشه...
...
while abs(result2 - result1) > 1e-10: #adaptive trapez
    n += 1
    result1 = result2
    result2 = trapez(a, b)
...
while abs(res2 - res1) >= 1e-10: #adaptive simp
